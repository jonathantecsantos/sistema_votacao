...
function calculateVoteAddress(payload) {
  return handlerInfo().prefix + getAddress(payload.electionName,20) + getAddress(payload.userNumber,20)
      + getAddress(payload.address,24);
}

const getAssetAddress = payload => handlerInfo().prefix + getAddress(payload.electionName,20)
    + getAddress(payload.userNumber,20) + getAddress(payload.address,24)
